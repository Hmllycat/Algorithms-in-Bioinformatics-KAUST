...
def profile_hmm(threshold, alphabet, alignments):
    ...
    transition.to_csv("D:/bioinformatics homework/chapter10/10_08_t.csv", sep="\t", float_format='%.3f')
    ...
    emission.to_csv("D:/bioinformatics homework/chapter10/10_08_e.csv", sep="\t", float_format='%.3f')
...
B-CCE-C-C
BA-DECC-D"""
    profile_hmm(0.319, "A	B	C	D	E".split(), al.split())
